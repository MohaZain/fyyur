...
Revision ID: 79ca46859b48
Revises: 625e0570b4d0
Create Date: 2021-06-27 13:22:05.909283
...
revision = '79ca46859b48'
down_revision = '625e0570b4d0'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.drop_constraint("show_venue_id_fkey",
                           type_="foreignkey", table_name="show")
    op.drop_constraint("show_artist_id_fkey",
                           type_="foreignkey", table_name="show")
    op.drop_table('venue')
